...
const NAV_STRUCTURE: (NavLeaf | NavGroup)[] = [
  ...
  { tab: 'formations', label: 'Formations', icon: GraduationCap },
...
export const AdminLayout: React.FC<AdminLayoutProps> = ({
  ...
  const handleToggleAccountMenu = () => {
    ...
    if (rect) {
      setAccountMenuPosition({ left: rect.right + 12, bottom: window.innerHeight - rect.bottom });
    }
  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="hidden lg:flex w-64 shrink-0 bg-[#002366] text-white flex-col sticky top-0 h-screen">
        ...
        <div ref={accountMenuRef} className="border-t border-blue-900 p-3 shrink-0">
          <button
      ...
      {isAccountMenuOpen &&
        ...
        createPortal(
          <div
            ...
            style={{ left: accountMenuPosition.left, bottom: accountMenuPosition.bottom }}
            className="fixed w-56 bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden z-[80] animate-scaleUp"
          >
