...
export const MemberCardPublic: React.FC<MemberCardPublicProps> = ({ member, onBackToHome, compact = false }) => {
  ...
  return (
    <div className={`${compact ? 'py-4 px-3 sm:px-5' : 'min-h-[85vh] py-12 px-4 sm:px-6 lg:px-8'} max-w-4xl mx-auto flex flex-col items-center justify-center bg-slate-50 text-[#0f172a]`}>
