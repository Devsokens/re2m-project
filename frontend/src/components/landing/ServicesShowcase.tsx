      ...
      {items.map((item, index) => {
        ...
        return (
          <div
            ...
            className={`group relative rounded-3xl overflow-hidden text-left cursor-pointer flex flex-col border transition-[flex-grow,background-color,box-shadow] duration-500 ease-in-out lg:min-h-[380px] ${
          ...
          >
            ...
            >
              ...
              />
              <div
                className={`absolute inset-0 bg-[#001845] transition-opacity duration-500 ease-in-out ${
